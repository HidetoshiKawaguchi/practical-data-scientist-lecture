...
logger.info(f"RMSE: {root_mean_squared_error(y_test, pred):.4f}")
logger.info(f"MAE : {mean_absolute_error(y_test, pred):.4f}")
logger.info(f"R^2 : {r2_score(y_test, pred):.4f}")
